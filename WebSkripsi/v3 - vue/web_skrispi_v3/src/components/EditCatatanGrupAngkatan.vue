    ...
    <div>
        ...
        <div id="content" class="container-fluid px-0">
            ...
            <div class="container-fluid px-0 mb-3">
                ...
                <div id="tambahCatatan" class="row pl-xl-3 pl-sm-2 mx-0 justify-content-center">
                            ...
                            <div class="col-12 mb-3 pl-2">
                                <div class="row">
                                    ...
                                    <div class="col-9 align-self-center">          
                                        <input id="inputKiri" type="text" placeholder="Masukan nama atau NIM Mahasiswa" v-model="tahunAngkatan">
                                    </div>
                                </div>
                            </div>
                ...
                <div id="inputanMultiline">
                    ...
                    <div id="containerPresensi" class="mt-5">
                        <div id="judulPresensi">
                            <p >Presensi Perwalian Grup Angkatan</p>
                        </div>
                    ...
                    <div id="buttonBatalSimpan" class="mt-xl-4">
...
export default {
    ...
    methods: {
        ...
        async initData() {
            const catatanId = this.$route.params.id.toString();
            this.dataCatatan = await this.$store.getters.getItemCatatanPerwalianDosenById(catatanId);
            this.tipe = this.dataCatatan.tipe
            this.waktu = this.dataCatatan.waktu
            this.waktuAwal = this.getWaktuSekarang()
            this.judul = this.dataCatatan.judul;
            this.tahunAngkatan = this.dataCatatan.tahunAngkatan;
            this.agendaPerwalian = this.dataCatatan.agendaPerwalian;
            this.listPresensi = this.dataCatatan["dataPresensiMahasiswa"]["data"]
        },
        simpan() {
