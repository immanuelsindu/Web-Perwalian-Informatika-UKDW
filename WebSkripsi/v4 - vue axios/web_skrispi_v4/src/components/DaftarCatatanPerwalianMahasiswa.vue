...
export default {
    ...
    methods: {
        ...
        async getFilteredCatatanMahasiswa() {
            try {
                const response = await axios.get(
                    process.env.VUE_APP_API + `/filteredCatatanMahasiswa/`, {
                        params: {
                            kode_dosen: this.kodeDosen,
        ...
        async loadCatatanMahasiswaHistori() {
            try {
                const response = await axios.get(
                    process.env.VUE_APP_API + `/catatanMahasiswaHistory/`, {
                        params: {
                            kode_dosen: this.kodeDosen,
                            nim: this.$route.params.id,
                        },
        ...
        async getTahunCatatanMahasiswaHistori() {
            try {
                const response = await axios.get(
                    process.env.VUE_APP_API + `/tahunCatatanMahasiswaHistory/`, {
                        params: {
                            kode_dosen: this.kodeDosen,
                            nim: this.$route.params.id,
                        },
        ...
        async arsipCatatanYa() {
            if (this.relasiCatatanArsip.tambah_peserta.length != 0) {
                for (
                    let i = 0; i < this.relasiCatatanArsip.tambah_peserta.length; i++
                ) {
                    const paramObject = {
