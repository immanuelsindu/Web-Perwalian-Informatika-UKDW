                        ...
                        <div id="overlay" v-if="this.isOn" class="d-flex justify-content-center align-items-center">
                            <div id="windowPreferensi">
                                <div id="contentPreferensi" class="p-4">
                                    ...
                                    <div class="row mb-3" id="opsiUrutan1">
                                    ...
                                    <div class="row mb-3" id="opsiUrutan2">
                                        <div class="col-8">
                                            <ul class="pl-3 ulNoType mb-0">
                                                <li class="">
                                                    <ol class="pl-4">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="col-12 p-0">
                                <div v-for="(item, index) in this.listTahunAngkatanBimbingan" :key="index"
                                    ...
                                    <transition>
                                        <div v-if="this.showInfoAngkatan.get(item)"
                                ...
                                <div class=" d-flex justify-content-center">
                                    <div class="row mb-lg-3" id="totalMahasiswaPerwalian">
                                        ...
                                        <div
                                            ...
                                            <p class="jumlahMahasiswaBimbingan">
...
export default {
    ...
    methods: {
        async initData() {
            //cek apakah kaprodi 
            // if(!this.getIsKaprodi()){ // jika bukan kaprodi
        ...
        async getIsKaprodi(){
            return  localStorage.getItem("isKaprodi")
        },
        async getJumlahStatusMahasiswa() {
            if (this.listTahunAngkatanBimbingan.length != 0) {
                for (let i = 0; i < this.listTahunAngkatanBimbingan.length; i++) {
                    ...
                    try {
                        const response = await axios.get(process.env.VUE_APP_API + `/jumlahStatusPerwalian/`, {
                            params: {
                    ...
                    try {
                        const response = await axios.get(process.env.VUE_APP_API + `/mahasiswaPerwalian/`, {
                            params: {
                                kode_dosen: this.kodeDosen,
                                tahun_angkatan: this.listTahunAngkatanBimbingan[i]
                            },
                    ...
                    try {
                        const response = await axios.get(process.env.VUE_APP_API + `/rataIPKAngkatanPerTahun/`, {
                            params: {
                                kode_dosen: this.kodeDosen,
                                tahun_angkatan: this.listTahunAngkatanBimbingan[i]
                            },
        ...
        async getTahunAngkatan() {
            ...
            try {
                const response = await axios.get(process.env.VUE_APP_API + `/angkatanMahasiswaPerwalian/`, {
                    params: {
                        kode_dosen: this.kodeDosen,
                    },
                });
        ...
        async getCatatanPerwalianDosenTerbaru() {
            ...
            try {
                const response = await axios.get(process.env.VUE_APP_API + `/catatanPerwalianDosenTerbaru/`, {
                    params: {
                        kode_dosen: this.kodeDosen
                    },
                });
        ...
        async getCatatanDosenTerbaru() {
            ...
            try {
                const response = await axios.get(process.env.VUE_APP_API + `/catatanDosenTerbaru/`, {
                    params: {
                        kode_dosen: this.kodeDosen
                    },
                });
        ...
        async getOpsiUrutanBeranda() {
            try {
                const response = await axios.get(process.env.VUE_APP_API + `/getOpsiBeranda/`, {
                    params: {
                        kode_dosen: this.kodeDosen,
                    },
                });
        ...
        async setOpsiUrutanBeranda() {
            try {
                ...
                const response = await axios.put(process.env.VUE_APP_API + `/setOpsiBeranda/`, paramObject);
        ...
        cariCatatanPerwalianDosen: debounce(async function () {
            if (this.inputanCariCatatanPerwalianDosen != '') {
                await axios
                    .get(process.env.VUE_APP_API + `/searchCatatanPerwalianDosen/`, {
                        params: {
                            kode_dosen: this.kodeDosen,
        ...
        cariCatatanDosen: debounce(async function () {
            if (this.inputanCariCatatanDosen != '') {
                await axios
                    .get(process.env.VUE_APP_API + `/searchCatatanDosen/`, {
                        params: {
                            kode_dosen: this.kodeDosen,
        ...
        cariMahasiswa: debounce(async function () {
            if (this.inputanCariMahasiswa != '') {
                await axios
                    .get(process.env.VUE_APP_API + `/searchMahasiswa/`, {
                        params: {
                            kode_dosen: this.kodeDosen,
