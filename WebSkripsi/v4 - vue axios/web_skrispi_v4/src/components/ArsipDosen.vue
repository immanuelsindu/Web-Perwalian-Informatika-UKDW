...
export default {
    ...
    methods: {
        async initData() {
            ...
            try {
                const response = await axios.get(process.env.VUE_APP_API + `/getTahunCatatanArsipDosen/`, {
                    params: {
        ...
        async filteredCatatanArsip() {
            try {
                const response = await axios.get(process.env.VUE_APP_API + `/getCatatanDosenArsipFiltered/`, {
                    params: {
                        kode_dosen: this.kodeDosen,
        ...
        async hapusCatatanYa() {
            try {
                ...
                const response = await axios.put(process.env.VUE_APP_API + `/deleteCatatanDosen/`, paramObject);
        ...
        async arsipCatatanYa() {
            try {
                ...
                const response = await axios.put(process.env.VUE_APP_API + `/updateIsArsipCatatanDosen/`, paramObject);
