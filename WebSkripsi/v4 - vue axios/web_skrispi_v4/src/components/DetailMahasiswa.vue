                    ...
                    <div id="resumeMahasiswa" class="col-12 mb-5 ml-3">
                        ...
                        <div id="resumeBaris2" class="row mb-5">
                            <div class="col-xl-4 col-md-8 mb-lg-3 mb-sm-3 col-sm-8">
                                <p id="judulProfilMahasiswa">Profil Profesional Mandiri</p>
...
export default {
    ...
    methods: {
        ...
        async getKRSMahasiswa() {
            try {
                const response = await axios.get(process.env.VUE_APP_API + `/getKRSMahasiswa/`, {
                    params: {
        ...
        async getCekalMahasiswa() {
            //get cekal mahasiswa 
            await axios.get(process.env.VUE_APP_API + `/cekalMahasiswa/`, {
                params: {
                    nim: this.$route.params.id
                },
        ...
        async getStatusMahasiswa() {
            ...
            await axios.get(process.env.VUE_APP_API + `/statusMahasiswa/`, {
                params: {
                    nim: this.$route.params.id
                },
            }).catch((error) => console.log(error.toJSON()))
        ...
        async getSACMahasiswa() {
            //get sac mahasiswa
            await axios.get(process.env.VUE_APP_API + `/sacMahasiswa/`, {
                params: {
                    nim: this.$route.params.id
                },
            }).catch((error) => console.log(error.toJSON()))
        ...
        async getIPKMahasiswa() {
            //get ipk mahasiswa
            await axios.get(process.env.VUE_APP_API + `/ipkSKSMahasiswa/`, {
                params: {
                    nim: this.$route.params.id
                },
            }).catch((error) => console.log(error.toJSON()))
        ...
        async getIPSMahasiswa() {
            //get ips mahasiswa 
            try {
                const response = await axios.get(process.env.VUE_APP_API + `/ipsMahasiswa/`, {
                    params: {
                        nim: this.$route.params.id
                    },
                });
        ...
        async getCatatanMahasiswaTerbaru() {
            ...
            await axios.get(process.env.VUE_APP_API + `/catatanMahasiswaTerbaru/`, {
                params: {
        ...
        async getListMataKuliah() {
            ...
            await axios.get(process.env.VUE_APP_API + `/matakuliahMahasiswa/`, {
                params: {
                    nim: this.$route.params.id
                },
            }).catch((error) => console.log(error.toJSON()))
