                                        ...
                                        <div class="d-flex col-9 align-self-center">
                                            ...
                                            <div class="d-flex align-self-center ml-2">
                                                ...
                                                <v-tooltip activator="parent" content-class="bg-grey-darken-1" max-width="300" location="right">Jika peserta adalah mahasiswa UKDW,
                                                    ...
                                                    cukup masukkan nama
                                                    peserta saja seperti "Nama Peserta".
                                                </v-tooltip>
                                            </div>
    ...
    methods: {
        ...
        async simpan() {
            ...
            if (!this.isFieldKosong()) {
                ...
                try {
                    const response = await axios.post(process.env.VUE_APP_API + `/tambahCatatanDosen/`, paramObject);
        ...
        isFieldKosong() { // true jika ada field yang kosong
            if (this.tipe == 'refleksi-dosen') {
                return (
                    this.judul == null || this.agendaPerwalian
                )
            } else {
                return (this.judul == null || this.agendaPerwalia == null || this.nama == null)
            }
        },
        getWaktuSekarang() {
            const now = new Date();
        ...
        async searchNamaMahasiswa() {
            try {
                const response = await axios.get(process.env.VUE_APP_API + `/searchMahasiswaKhusus/`, {
                    params: {
