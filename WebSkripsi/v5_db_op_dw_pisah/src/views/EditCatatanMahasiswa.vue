      ...
      if (!this.isFieldKosong()) {
        ...
        if (this.listMahasiswaPesertaLainnya.length > 0) {
          for (let i = 0; i < this.listMahasiswaPesertaLainnya.length; i++) {
            // cek kalau daftar peserta yang lama 
            if (this.listMahasiswaPesertaLainnya[i].id_catatan_perwalian_dosen != 0) {
            ...
            // jika peserta lain tidak punya id_catatan yang di insert sebelumnya , berarti dia peserta baru => insert data baru
              ...
              try {
                ...
                if (response.data.success) {
                  ...
                  this.listMahasiswaPesertaLainnya[i].id_catatan_perwalian_dosen = response.data.id_catatan_perwalian_dosen;
                }
              } catch (error) {
                console.error(
