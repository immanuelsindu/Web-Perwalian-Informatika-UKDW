              ...
              <div class="row">
                ...
                <div id="opsiTipePerwalian" class="pl-1">
                  <div class="col-12  mb-1 d-flex align-items-center">
                    <input class="form-check-input" type="radio" name="flexRadioDefault" value="refleksi-dosen"
                      id="flexRadioDefault1" v-model="tipe" :checked="tipe === 'refleksi-dosen' ? true : false">
                  ...
                  <div class="col-12 mb-1 d-flex align-items-center">
                    <input class="form-check-input" type="radio" name="flexRadioDefault" value="khusus"
                      id="flexRadioDefault2" v-model="tipe">
              ...
              <div class="row ml-sm-1 mb-3">
                    ...
                    <div v-if="tipe == 'khusus'" class="row mb-3">
                      ...
                      <div class="d-flex col-9 align-self-center">
                        ...
                        <div class="d-flex align-self-center ml-2">
                          ...
                          <v-tooltip activator="parent" content-class="bg-grey-darken-1" max-width="300"
                            location="right">Jika peserta adalah mahasiswa UKDW,
                        ...
                        <div v-if="this.listCariMahasiswa.length > 0" id="hoverCariPeserta" class="mt-5 pt-2">
                          <ul class="list-group">
                            <li v-for="(mahasiswa, index) in this.listCariMahasiswa" :key="index"
                              class="list-group-item py-2" @click="selectedIndex(mahasiswa)">
                              {{ mahasiswa.nama }} / {{ mahasiswa.nim }}
                            </li>
                          </ul>
                        </div>
                        <div v-else-if="this.handlingInputCariNama" id="hoverCariPeserta"
                          class="mt-5 pt-2 py-4 text-center">
                          <ul class="list-group">
                ...
                <div class="col-12 pl-2">
                  <div class="row">
                    ...
                    <div class="col-9">
                      <input type="text" class="inputJudulKonsul dropdown-toggle" placeholder="Masukan judul perwalian"
                        v-model="judul">
                    </div>
                  </div>
                </div>
      ...
      <div class="d-flex justify-content-center">
        <div id="inputanMultiline">
          <div id="kolomInputan" class="d-flex justify-content-center">
            <textarea name="agendaPerwalian" id="agendaPerwalian" cols="160" rows="10"
              placeholder="Tulis agenda perwalian di sini" v-model="agendaPerwalian"></textarea>
          </div>
          ...
          <div id="buttonBatalSimpan2" class="mt-3">
            <div class="row justify-content-between">
              ...
              <div class="col-xl-6 col-sm-6 d-flex justify-content-end mb-5">
                <v-btn type="submit" :disabled="this.tombolTidakAktif" id="buttonSimpan"
                  @click="this.simpan()">Simpan</v-btn>
              </div>
            </div>
          </div>
        </div>
