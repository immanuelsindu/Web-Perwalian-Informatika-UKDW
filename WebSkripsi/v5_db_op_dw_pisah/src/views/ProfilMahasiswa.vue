            ...
            <div id="listMatkul" class="row">
              <div class="col-7 pr-0">
                ...
                <ol>
                  ...
                  <li v-for="(index2) in this.listMataKuliahWajibProfil[index - 1].length" :key="index2">
                    ...
                    <span v-if="this.isAmbilMataKuliahProfil(this.listMataKuliahWajibProfil[index - 1][index2 - 1])"
              ...
              <div class="col-5 p-0">
                ...
                <ul>
                  ...
                  <li v-for="(index3) in this.listMataKuliahOpsionalProfil[index - 1].length" :key="index3">
