                        ...
                        <div id="bagianPencarian" class="d-flex ml-3 mt-5 ">
                            <div class="col-12 m-0 p-0">
                                ...
                                <div id="infoMahasiswaBimbingan" class="d-flex flex-row flex-wrap col-12">
                                     ...
                                     <div v-if="this.jumlahAktifDanTidakAktif > 0" class="itemInfoMahasiswaBimbingan" :class="{ selected: this.selectedItems.includes('Aktif dan Tidak Aktif') }">
                                        <div class="d-flex align-items-center col-12 semuaMahasiswa" @click="this.toggleItemSelection('Aktif dan Tidak Aktif')">
                                            <div class="col-12 p-0">
